...
<body>
 ...
 $sql ="select * from cart inner join cloth on cart.c_id = cloth.c_id and cart.username = '$username'" or
die("Error:" . mysqli_error());
 ...
 <th></th><th id="th_1">ชื่อสินค้า</th><th id="th_1">เพศ</th><th id="th_1">สี</th><th id="th_1">จำนวน</th><th id="th_1">ราคา</
th><th id="th_1">ราคารวม</th>
 </tr>
 <?PHP
 while($rs = mysqli_fetch_array($result)){
 ?>
 <tr>
 <td><font id="a3"> <img src = "<?PHP echo "images/".$rs['pic']; ?>" height="180" width="150"> </font> </td>
 <td><font id="a3"> <?PHP echo $rs['c_name']; ?> </font> </td>
 <td><font id="a3"> <?PHP echo $rs['gender']; ?> </font> </td>
 <td><font id="a3"> <?PHP echo $rs['color']; ?> </font> </td>
 <td><font id="a3"> <?PHP echo $rs['amount']; ?> </font> </td>
 <td><font id="a3"> <?PHP echo $rs['price']; ?> </font> </td>
 <td><font id="a3"> <?PHP echo $rs['total']; ?> </font> </td>
 </tr>
 <?PHP
 ...
 if($i > 0){
 for($j = 0; $j < $i; $j++) {
    $sql_insert ="Insert into orders (o_id, c_id, c_name, username, date_order, price, amount, total,
    card_number, order_status)
     Values($o_id+1, $array_c_id[$j], '$array_c_name[$j]', '$username', '$date_order',
    $array_price[$j], $array_amount[$j], $array_total[$j], '$card_number', 'placed')";
