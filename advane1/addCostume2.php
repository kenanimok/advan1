    ...
    <div class="container">
        <form name="addCloth_form" method="post" action="costumeInsert.php" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-75">
                    <br>
                    <label id="font">&nbsp;เลือกรูปภาพ: </label><input type="file" name="pic" id="ip" placeholder="รูป"
            ...
            <div class="row">
                <div class="col-75">
                    <label id="font">&nbsp;สินค้าคงเหลือ (ชิ้น): </label><input type="number" id="font2" name="stock"
