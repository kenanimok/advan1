...
$username; ?>">Back</a></h3>
 ...
 <th id="th_1">Order id</th><th id="th_1">Username</th><th id="th_1">Date Order</th><th
id="th_1">Amount</th><th id="th_1">Total</th><th id="th_1">Order status</th><th id="th_1">Change
status</th> <th colspan="4"></th>
 </tr>
 <?PHP
 while($rs = mysqli_fetch_array($result)){
 ?>
 <tr>
 <td><font id="a3"><?PHP echo $rs['o_id']; ?> </font> </td>
 <td><font id="a3"> <?PHP echo $rs['username']; ?> </font> </td>
 <td><font id="a3"> <?PHP echo $rs['date_order']; ?> </font> </td>
 <td><font id="a3"> <?PHP echo $rs['sum(amount)']; ?> </font> </td>
 <td><font id="a3"> <?PHP echo $rs['sum(total)']; ?> </font> </td>
 <td><font id="a4"> <?PHP echo $rs['order_status']; ?> </font> </td>
 <form name ="editOrder_form" method="get" action = "editOrder.php" >
 <input type ="hidden" name="o_id" value=<?PHP echo $rs['o_id']; ?> />
 <td><font id="status"> <select name="order_status" id="order_status">
