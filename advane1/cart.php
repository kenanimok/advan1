...
<script>
 ...
 ?>
 <div class="container">
 <p align ="left" ><a href = "costume.php"><img src = "home.png" width="50"
height="50"></a></p>
...
= '$username'" or die("Error:" . mysqli_error());
 ...
 <th id="th_1"></th><th id="th_1">ชื่อสินค้า</th><th id="th_1">เพศ</th><th id="th_1">สี</th><th
id="th_1">จ านวน</th><th id="th_1">ราคา</th><th id="th_1">ราคารวม</th> <th colspan="2"></th>
 </tr>
 <?PHP
 while($rs = mysqli_fetch_array($result)){
 ?>
 <tr>
 <td><font id="a3"> <img src = "<?PHP echo "images/".$rs['pic']; ?>" height="180"
width="150"> </font> </td>
...
<table align="center" >
<tr height="70">
<td colspan="2"><p id="p3" style="font-weight: bold;">Pleas Enter Payment
Number:</p>
</td>
</tr>
</table>
...
</td><form name="placeOrder" action= "placeOrder.php" method="GET">
...
style="width:120px">Plac Order</button>
</form>
</td>
